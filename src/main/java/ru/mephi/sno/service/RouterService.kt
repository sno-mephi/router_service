...
import ru.sbrbase.service.RedisService
import ru.sbrbase.util.CoroutineManager
import ru.sbrbase.util.ReleasesPropertiesStorage
import java.net.URL
...
class RouterService(
    ...
    // TODO: вынести в sbrbase
    private val RR_IS_FIRST_ACTIVE = "release_is_first_active"
